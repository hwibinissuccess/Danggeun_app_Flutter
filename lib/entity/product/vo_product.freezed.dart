...
class _$_Product implements _Product {
  const _$_Product(this.user, this.name, this.price, this.description,
      this.statuc, final List<String> images)
      : _images = images;
  ...
  @override
  String toString() {
    return 'Product(user: $user, name: $name, price: $price, description: $description, statuc: $statuc, images: $images)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, user, name, price, description,
      statuc, const DeepCollectionEquality().hash(_images));
